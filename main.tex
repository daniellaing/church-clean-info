...
\begin{description}
    ...
    \item[Supplies:] If any supplies are missing, running low, or you use the last of, contact \emph{Kev or Wendy} at
        +44~7584~293680 or \email{kevlegge1@yahoo.co.uk}.
\end{description}
